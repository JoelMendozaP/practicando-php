...
$name = "Joel $lastName";
/*
para ver que pasa con mi variable
var_dump($name);
*/
    ...
    <div id="resume-header" class="row">
      ...
      <div class="col">
        ...
        <ul>
          <li>
            Mail:
            <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="335b5650475c41735e525a5f1d505c5e">[email&#160;protected]</a>
          </li>
          <li>Phone: 78944081</li>
          <li>LinkedIn: https://www.linkedin.com/in/joelmendozapaucara/</li>
          <li>Twitter: @JoelMVP</li>
        </ul>
      </div>
    </div>
    <div class="row">
